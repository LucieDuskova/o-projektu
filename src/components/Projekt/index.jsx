...
export const Projekt = () => {
  return (
    <main>
      <img src="./img/Patchwork.png" alt="herní plán Patchwork" />
      <p>
        ...
        eveniet recusandae, hic accusamus? Perferendis nesciunt, veritatis earum
        veniam atque eaque officiis! Et, sint.
      </p>
    </main>
  );
};
